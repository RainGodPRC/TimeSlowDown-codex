...
check(projectText.contains("CURRENT_PROJECT_VERSION = 90;"), "Xcode project build settings should carry v90 build number")
...
check(infoPlistText.contains("<string>90</string>"), "Info.plist should carry v90 build number")
...
check(buildNotes.buildNumber == "90", "TestFlight build notes should match v90")
check(buildNotes.summary.localizedCaseInsensitiveContains("decade-scale history"), "TestFlight build notes should describe the v90 decade-scale Timeline projection")
check(buildNotes.summary.localizedCaseInsensitiveContains("3,650-day, 7,300-revisit benchmark"), "TestFlight build notes should disclose the v90 long-history benchmark")
...
check(appStoreSubmissionGate.buildNumber == "90", "App Store submission gate should track v90")
check(appStoreSubmissionGate.rows.count == 30, "App Store submission gate should keep thirty release gates after v90 Timeline performance hardening")
