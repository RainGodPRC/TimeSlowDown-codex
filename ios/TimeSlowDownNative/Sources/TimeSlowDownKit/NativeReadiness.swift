...
public enum NativeHandoffLedger {
    public static let rows: [ReadinessRow] = [
        ...
        .init(id: "privacy-manifest", title: "Privacy Manifest / required reason API", status: .poc, owner: "release", evidence: "v69 adds a Swift-verifiable required reason API audit packet for the current no-tracking/no-collected-data/no-accessed-API privacy manifest; final Xcode privacy report, dependency privacy manifest review, and release/legal review remain required."),
        .init(id: "testflight-packet", title: "TestFlight packet", status: .poc, owner: "release", evidence: "v40 TestFlight build notes, App Review route, signing plan, and launch asset checklist exist as Swift-verifiable contracts; v67 adds an archive/signing readiness packet for future full-Xcode archive and TestFlight upload evidence; v68 adds an App Store metadata/legal review packet; v69 adds a Privacy Manifest required reason API audit packet; v70 adds an encryption export compliance review packet; v71 adds a screenshot/App Preview creative packet; real archive/upload still requires full Xcode and Apple Developer team.")
    ]
}
...
public enum SubmissionPacket {
    public static let rows: [ReadinessRow] = [
        ...
        .init(id: "screenshot-app-preview-creative-packet", title: "Screenshot/App Preview creative packet", status: .poc, owner: "design/release", evidence: "v71 Swift-verifiable packet maps Memory Camera, today slice, weekly chapter, life meadow, media wall, and Account Rights scenes to App Store screenshot/App Preview requirements before rendered assets and App Store Connect upload."),
        .init(id: "encryption-export-compliance-packet", title: "Encryption export compliance packet", status: .poc, owner: "legal/release", evidence: "v70 Swift-verifiable packet maps CryptoKit AES.GCM, Secure Enclave, Keychain metadata, encrypted media vault, and HTTPS transport to export-compliance review before formal App Store Connect answers and legal classification."),
