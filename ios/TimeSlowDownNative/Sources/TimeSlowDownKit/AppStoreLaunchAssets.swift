...
public struct TestFlightBuildNotes: Codable, Equatable, Sendable {
    ...
    public init(
        ...
        knownLimitations: [String] = [
            ...
            "v79 adds source-backed week/month/year/decade Meadow projection, source sheets, and a plain chronological river; person/theme lenses, a persisted Life Marks provenance ledger, and signed-device accessibility receipts remain follow-up work.",
...
public struct AppStoreSubmissionGate: Codable, Equatable, Sendable {
    ...
    public init(buildNumber: String = "79", rows: [AppStoreSubmissionGateRow]) {
        self.buildNumber = buildNumber
        self.rows = rows
    }
