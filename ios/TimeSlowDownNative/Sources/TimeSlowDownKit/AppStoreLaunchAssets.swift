...
public struct TestFlightBuildNotes: Codable, Equatable, Sendable {
    ...
    public init(
        buildNumber: String = "40",
        summary: String = "TimeSlowDown v40 tests the native Memory Camera shell, media-first slice capture, weekly chapter preview, App Store launch assets, and privacy/export/delete/AI trust boundaries.",
        testerRoute: [String] = [
        ...
        knownLimitations: [String] = [
            ...
            "No real Keychain/Secure Enclave persistence or E2EE media vault is claimed yet.",
