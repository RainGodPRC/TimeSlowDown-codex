...
public struct TestFlightBuildNotes: Codable, Equatable, Sendable {
    ...
    public init(
        buildNumber: String = "41",
        summary: String = "TimeSlowDown v41 tests the native Memory Camera shell, media-first slice capture, weekly chapter preview, App Store launch assets, Keychain record store adapter, and privacy/export/delete/AI trust boundaries.",
        testerRoute: [String] = [
